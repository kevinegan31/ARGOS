...
## lasso --------------
xdot_vdp_lasso <- read.csv("SNR/vdp_inc_snr_xdot_lasso_pred_models_new_sg.csv")[,-1]
ydot_vdp_lasso <- read.csv("SNR/vdp_inc_snr_ydot_lasso_pred_models_new_sg.csv")[,-1]
...
lasso_plot2_snr <- lasso_plot_snr+theme(legend.position='none')+
  annotate("rect", xmin = 2.5, xmax = 7.5, ymin = -10, ymax = 450,
           alpha = 0, color= "purple",lwd=1)
## alasso ------------------
xdot_vdp_alasso <- read.csv("SNR/vdp_inc_snr_xdot_alasso_pred_models_new_sg.csv")[,-1]
ydot_vdp_alasso <- read.csv("SNR/vdp_inc_snr_ydot_alasso_pred_models_new_sg.csv")[,-1]
...
alasso_plot2_snr <- alasso_plot_snr+theme(legend.position='none')+
  annotate("rect", xmin = 2.5, xmax = 7.5, ymin = -10, ymax = 320,
           alpha = 0, color= "purple",lwd=1)
## STLS -------------------------
xdot_vdp_STLS <- read.csv("SNR/vdp_inc_snr_xdot_sindy_pred_models_new_sg.csv")[,-1]
ydot_vdp_STLS <- read.csv("SNR/vdp_inc_snr_ydot_sindy_pred_models_new_sg.csv")[,-1]
...
STLS_plot2_snr <- STLS_plot_snr+theme(legend.position='none')+
  annotate("rect", xmin = 2.5, xmax = 6.5, ymin = -10, ymax = 320,
           alpha = 0, color= "purple",lwd=1)
...
ggsave(stacked_vdp_snr, filename = './stacked_vdp_snr.pdf', width = 10, height = 15, dpi = 300)
ggsave(stacked_vdp_snr, filename = './stacked_vdp_snr.png', width = 10, height = 15, dpi = 300)
