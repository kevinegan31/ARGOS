...
ggplot_data_snr <- function(algorithm, xdot_rossler, ydot_rossler, zdot_rossler, threshold = 40){
  ...
  plot_data_xdot <- cbind.data.frame(eq = 'xdot',names = rownames(x_dot_rossler_terms_data),
  ...
  plot_data_ydot <- cbind.data.frame(eq = 'ydot', names = rownames(y_dot_rossler_terms_data),
  ...
  plot_data_zdot <- cbind.data.frame(eq = 'zdot', names = rownames(z_dot_rossler_terms_data),
...
## lasso --------------
xdot_rossler_lasso <- read.csv("SNR/rossler_inc_snr_xdot_lasso_pred_models_new_sg.csv")[,-1]
ydot_rossler_lasso <- read.csv("SNR/rossler_inc_snr_ydot_lasso_pred_models_new_sg.csv")[,-1]
...
zdot_rossler_STLS <- read.csv("SNR/rossler_inc_snr_zdot_sindy_pred_models_new_sg.csv")[,-1]
