...
ggsave(stacked_rossler, filename = './stacked_rossler_snr.pdf', width = 10, height = 15, dpi = 300)
ggsave(stacked_rossler, filename = './stacked_rossler_snr.png', width = 10, height = 15, dpi = 300)
