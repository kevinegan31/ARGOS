...
ggsave(stacked_cubic2d_snr, filename = '../../../Figures/stacked_cubic2d_snr.pdf', width = 10, height = 15, dpi = 300)
ggsave(stacked_cubic2d_snr, filename = '../../../Figures/stacked_cubic2d_snr.png', width = 10, height = 15, dpi = 300)
