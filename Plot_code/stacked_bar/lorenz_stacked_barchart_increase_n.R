...
## lasso --------------
xdot_lorenz_lasso_reg_df <- read.csv("N/lorenz_inc_n_xdot_lasso_pred_models_new_sg.csv")[-1]
...
zdot_lorenz_sindy_reg_df <- read.csv("N/lorenz_inc_n_zdot_sindy_pred_models_new_sg.csv")[-1]
n_seq_desired <- c(1,6)
