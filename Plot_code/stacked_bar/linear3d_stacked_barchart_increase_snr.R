...
library(stringr)
library(gridExtra)
# setwd('D:/Users/Administrator/OneDrive - Durham University/Proc_Royal_Soc_A/Data/linear3d')
# setwd('/Users/kevinegan/OneDrive - Durham University/Proc_Royal_Soc_A/Data/linear3d')
...
ggplot_data_snr <- function(algorithm, xdot_linear3d, ydot_linear3d, zdot_linear3d, threshold=40){
  ...
  # xdot_linear3d_reg_list <- split(data.frame(xdot_linear3d), seq_along(snr_seq))
  ...
  # ydot_linear3d_reg_list <- split(ydot_linear3d, seq_along(snr_seq))
  ...
  # zdot_linear3d_reg_list <- split(zdot_linear3d, seq_along(snr_seq))
  ...
  # plot_data2 <- dplyr::filter(plot_data2, snr!='values.22') # remove snr=Inf
...
## lasso --------------
xdot_linear3d_lasso <- read.csv("xdot_linear3d_lasso_increasing_snr_prediction_models_N_5000_TAPER_new_sg.csv")[,-1]
ydot_linear3d_lasso <- read.csv("ydot_linear3d_lasso_increasing_snr_prediction_models_N_5000_TAPER_new_sg.csv")[,-1]
zdot_linear3d_lasso <- read.csv("zdot_linear3d_lasso_increasing_snr_prediction_models_N_5000_TAPER_new_sg.csv")[,-1]
...
## alasso ------------------
xdot_linear3d_alasso <- read.csv("xdot_linear3d_alasso_increasing_snr_prediction_models_N_5000_TAPER_new_sg.csv")[,-1]
ydot_linear3d_alasso <- read.csv("ydot_linear3d_alasso_increasing_snr_prediction_models_N_5000_TAPER_new_sg.csv")[,-1]
zdot_linear3d_alasso <- read.csv("zdot_linear3d_alasso_increasing_snr_prediction_models_N_5000_TAPER_new_sg.csv")[,-1]
...
## STLS -------------------------
xdot_linear3d_STLS <- read.csv("xdot_linear3d_sindy_increasing_snr_prediction_models_N_5000_new_sg.csv")[,-1]
ydot_linear3d_STLS <- read.csv("ydot_linear3d_sindy_increasing_snr_prediction_models_N_5000_new_sg.csv")[,-1]
zdot_linear3d_STLS <- read.csv("zdot_linear3d_sindy_increasing_snr_prediction_models_N_5000_new_sg.csv")[,-1]
...
# source(paste0(
#   "D:/GitHub/",
#   "Iterative-Sparse-Regression/Plot_Code/linear3d/linear3d_boxplot_number_of_selected_variables_increasing_snr.R"))
## compose -----------------
library(gridExtra)
