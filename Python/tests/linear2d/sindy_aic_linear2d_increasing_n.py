...
xdot_models.to_csv('./sindy_aic_linear2d_snr_%s_increasing_N%s_%s_max_iter_%s_lambda_10%s_%s_num_lambda_%s_xdot.csv' % (snr, START, END, max_iter_num, lambda_min, lambda_max, num_lambda))
ydot_models.to_csv('./sindy_aic_linear2d_snr_%s_increasing_N%s_%s_max_iter_%s_lambda_10%s_%s_num_lambda_%s_ydot.csv' % (snr, START, END, max_iter_num, lambda_min, lambda_max, num_lambda))
