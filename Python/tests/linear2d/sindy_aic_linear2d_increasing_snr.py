...
orig_init_condition_vector = (np.random.uniform(-10,3, n*100,))
...
validation_init_condition_vector = (np.random.uniform(-10,3, n*100,))
...
xdot_models.to_csv('./sindy_aic_linear2d_increasing_snr_%s_%s_N%s_max_iter_%s_SEED_%s_lambda_%s_%s_num_lambda_%s_xdot.csv' % (noise_start, noise_end, n_obs, max_iter_num, seed, lambda_min, lambda_max, num_lambda))
ydot_models.to_csv('./sindy_aic_linear2d_increasing_snr_%s_%s_N%s_max_iter_%s_SEED_%s_lambda_%s_%s_num_lambda_%s_ydot.csv' % (noise_start, noise_end, n_obs, max_iter_num, seed, lambda_min, lambda_max, num_lambda))
