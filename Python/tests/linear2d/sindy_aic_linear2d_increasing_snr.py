...
xdot_models.to_csv(
    "./sindy_aic_linear2d_increasing_snr_%s_%s_N%s_max_iter_%s_SEED_%s_lambda_%s_%s_num_lambda_%s_xdot.csv"
    % (
        noise_start,
        noise_end,
        n_obs,
...
ydot_models.to_csv(
    "./sindy_aic_linear2d_increasing_snr_%s_%s_N%s_max_iter_%s_SEED_%s_lambda_%s_%s_num_lambda_%s_ydot.csv"
    % (
        noise_start,
        noise_end,
        n_obs,
