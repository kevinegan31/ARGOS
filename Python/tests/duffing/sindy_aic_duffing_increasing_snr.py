...
validation_init_condition_vector = [
    i for tup in zip(x_init_conditions, y_init_conditions) for i in tup
]
...
xdot_models.to_csv(
    "./sindy_aic_duffing_increasing_snr_%s_%s_N%s_max_iter_%s_SEED_%s_lambda_%s_%s_num_lambda_%s_xdot.csv"
    % (
        noise_start,
        noise_end,
        n_obs,
...
ydot_models.to_csv(
    "./sindy_aic_duffing_increasing_snr_%s_%s_N%s_max_iter_%s_SEED_%s_lambda_%s_%s_num_lambda_%s_ydot.csv"
    % (
        noise_start,
        noise_end,
        n_obs,
