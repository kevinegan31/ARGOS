...
x_orig_init_conditions = np.random.uniform(-10,10,100,)
y_orig_init_conditions = np.random.uniform(-10,10,100,)
z_orig_init_conditions = np.random.uniform(0,20,100,)
...
x_val_init_conditions = np.random.uniform(-10,10,100,)
y_val_init_conditions = np.random.uniform(-10,10,100,)
z_val_init_conditions = np.random.uniform(0,20,100,)
...
xdot_models.to_csv('./sindy_aic_rossler_snr_%s_increasing_N%s_%s_max_iter_%s_lambda_10%s_%s_num_lambda_%s_xdot.csv' % (snr, START, END, max_iter_num, lambda_min, lambda_max, num_lambda))
ydot_models.to_csv('./sindy_aic_rossler_snr_%s_increasing_N%s_%s_max_iter_%s_lambda_10%s_%s_num_lambda_%s_ydot.csv' % (snr, START, END, max_iter_num, lambda_min, lambda_max, num_lambda))
zdot_models.to_csv('./sindy_aic_rossler_snr_%s_increasing_N%s_%s_max_iter_%s_lambda_10%s_%s_num_lambda_%s_zdot.csv' % (snr, START, END, max_iter_num, lambda_min, lambda_max, num_lambda))
