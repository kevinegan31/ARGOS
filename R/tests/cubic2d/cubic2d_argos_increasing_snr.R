...
init_sequence <- list()
for (i in 1:num_init) {
  init_sequence[[i]] <- runif(num_state_var, min=-10, max=10)
}
init_sequence <-
  rep(init_sequence,
...
if (lasso_method == "lasso") {
  write.csv(
    xdot_pe_df,
    sprintf(
      "~/xdot_cubic2d_increasing_snr_%s_N%s_B%s_snr_%s_%s_SEED_%s_pe_df.csv",
      lasso_method,
      n_obs,
      num_samples,
      start,
  ...
  write.csv(
    xdot_ci_df,
    sprintf(
      "~/xdot_cubic2d_increasing_snr_%s_N%s_B%s_snr_%s_%s_SEED_%s_ci_df.csv",
      lasso_method,
      n_obs,
      num_samples,
      start,
  ...
  write.csv(
    xdot_pe_df,
    sprintf(
      "~/xdot_cubic2d_increasing_snr_%s_%s_N%s_B%s_snr_%s_%s_SEED_%s_pe_df.csv",
      lasso_method,
  ...
  write.csv(
    xdot_ci_df,
    sprintf(
      "~/xdot_cubic2d_increasing_snr_%s_%s_N%s_B%s_snr_%s_%s_SEED_%s_ci_df.csv",
      lasso_method,
      alasso_weights_method,
      n_obs,
      num_samples,
...
if (lasso_method == "lasso") {
  write.csv(
    ydot_pe_df,
    sprintf(
      "~/ydot_cubic2d_increasing_snr_%s_N%s_B%s_snr_%s_%s_SEED_%s_pe_df.csv",
      lasso_method,
      n_obs,
      num_samples,
      start,
  ...
  write.csv(
    ydot_ci_df,
    sprintf(
      "~/ydot_cubic2d_increasing_snr_%s_N%s_B%s_snr_%s_%s_SEED_%s_ci_df.csv",
      lasso_method,
      n_obs,
      num_samples,
      start,
  ...
  write.csv(
    ydot_pe_df,
    sprintf(
      "~/ydot_cubic2d_increasing_snr_%s_%s_N%s_B%s_snr_%s_%s_SEED_%s_pe_df.csv",
      lasso_method,
      alasso_weights_method,
      n_obs,
      num_samples,
  ...
  write.csv(
    ydot_ci_df,
    sprintf(
      "~/ydot_cubic2d_increasing_snr_%s_%s_N%s_B%s_snr_%s_%s_SEED_%s_ci_df.csv",
      lasso_method,
      alasso_weights_method,
      n_obs,
      num_samples,
