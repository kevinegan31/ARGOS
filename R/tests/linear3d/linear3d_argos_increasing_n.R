...
if (lasso_method == "lasso") {
  write.csv(
    xdot_pe_df,
    sprintf(
      "~/xdot_linear3d_increasing_n_%s_N%s_%s_B%s_snr_%s_SEED_%s_pe_df.csv",
      lasso_method,
      start,
      end,
      num_samples,
  ...
  write.csv(
    xdot_ci_normal_df,
    sprintf(
      "~/xdot_linear3d_increasing_n_%s_N%s_%s_B%s_snr_%s_SEED_%s_ci_normal_df.csv",
      lasso_method,
      start,
      end,
      num_samples,
  ...
  write.csv(
    xdot_pe_df,
    sprintf(
      "~/xdot_linear3d_increasing_n_%s_%s_N%s_%s_B%s_snr_%s_SEED_%s_pe_df.csv",
      lasso_method,
  ...
  write.csv(
    xdot_ci_normal_df,
    sprintf(
      "~/xdot_linear3d_increasing_n_%s_%s_N%s_%s_B%s_snr_%s_SEED_%s_ci_normal_df.csv",
      lasso_method,
      alasso_weights_method,
      start,
      end,
...
if (lasso_method == "lasso") {
  write.csv(
    ydot_pe_df,
    sprintf(
      "~/ydot_linear3d_increasing_n_%s_N%s_%s_B%s_snr_%s_SEED_%s_pe_df.csv",
      lasso_method,
      start,
      end,
      num_samples,
  ...
  write.csv(
    ydot_ci_normal_df,
    sprintf(
      "~/ydot_linear3d_increasing_n_%s_N%s_%s_B%s_snr_%s_SEED_%s_ci_normal_df.csv",
      lasso_method,
      start,
      end,
      num_samples,
  ...
  write.csv(
    ydot_pe_df,
    sprintf(
      "~/ydot_linear3d_increasing_n_%s_%s_N%s_%s_B%s_snr_%s_SEED_%s_pe_df.csv",
      lasso_method,
      alasso_weights_method,
      start,
      end,
  ...
  write.csv(
    ydot_ci_normal_df,
    sprintf(
      "~/ydot_linear3d_increasing_n_%s_%s_N%s_%s_B%s_snr_%s_SEED_%s_ci_normal_df.csv",
      lasso_method,
      alasso_weights_method,
      start,
      end,
...
if (lasso_method == "lasso") {
  write.csv(
    zdot_pe_df,
    sprintf(
      "~/zdot_linear3d_increasing_n_%s_N%s_%s_B%s_snr_%s_SEED_%s_pe_df.csv",
      lasso_method,
      start,
      end,
      num_samples,
  ...
  write.csv(
    zdot_ci_normal_df,
    sprintf(
      "~/zdot_linear3d_increasing_n_%s_N%s_%s_B%s_snr_%s_SEED_%s_ci_normal_df.csv",
      lasso_method,
      start,
      end,
      num_samples,
  ...
  write.csv(
    zdot_pe_df,
    sprintf(
      "~/zdot_linear3d_increasing_n_%s_%s_N%s_%s_B%s_snr_%s_SEED_%s_pe_df.csv",
      lasso_method,
      alasso_weights_method,
      start,
      end,
  ...
  write.csv(
    zdot_ci_normal_df,
    sprintf(
      "~/zdot_linear3d_increasing_n_%s_%s_N%s_%s_B%s_snr_%s_SEED_%s_ci_normal_df.csv",
      lasso_method,
      alasso_weights_method,
      start,
      end,
