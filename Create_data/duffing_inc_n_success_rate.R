...
## read files -----------------------------------------
x_dot_lasso_ci <- read.csv('pred_model_csv/N/duffing_inc_n_xdot_lasso_ci_df.csv')[,-1]
x_dot_lasso_pe <- read.csv('pred_model_csv/N/duffing_inc_n_xdot_lasso_pe_df.csv')[,-1]
y_dot_lasso_ci <- read.csv('pred_model_csv/N/duffing_inc_n_ydot_lasso_ci_df.csv')[,-1]
y_dot_lasso_pe <- read.csv('pred_model_csv/N/duffing_inc_n_ydot_lasso_pe_df.csv')[,-1]

x_dot_alasso_ci <- read.csv('pred_model_csv/N/duffing_inc_n_xdot_alasso_ci_df.csv')[,-1]
x_dot_alasso_pe <- read.csv('pred_model_csv/N/duffing_inc_n_xdot_alasso_pe_df.csv')[,-1]
y_dot_alasso_ci <- read.csv('pred_model_csv/N/duffing_inc_n_ydot_alasso_ci_df.csv')[,-1]
y_dot_alasso_pe <- read.csv('pred_model_csv/N/duffing_inc_n_ydot_alasso_pe_df.csv')[,-1]

x_dot_pysindy_pe <- read.csv('pred_model_csv/N/duffing_inc_n_xdot_pysindy_pe_df.csv')[,-1]
y_dot_pysindy_pe <- read.csv('pred_model_csv/N/duffing_inc_n_ydot_pysindy_pe_df.csv')[,-1]
...
write.csv(xdot_lasso_prediction_model,
          "stacked_bar_csv/N/duffing_inc_n_xdot_lasso_pred_models_new_sg.csv")
write.csv(ydot_lasso_prediction_model,
          "stacked_bar_csv/N/duffing_inc_n_ydot_lasso_pred_models_new_sg.csv")

## alasso 
write.csv(xdot_alasso_prediction_model,
          "stacked_bar_csv/N/duffing_inc_n_xdot_alasso_pred_models_new_sg.csv")
write.csv(ydot_alasso_prediction_model,
          "stacked_bar_csv/N/duffing_inc_n_ydot_alasso_pred_models_new_sg.csv")

## sindy
write.csv(xdot_pysindy_prediction_model,
          "stacked_bar_csv/N/duffing_inc_n_xdot_sindy_pred_models_new_sg.csv")
write.csv(ydot_pysindy_prediction_model,
          "stacked_bar_csv/N/duffing_inc_n_ydot_sindy_pred_models_new_sg.csv")
...
total_correct_increasing_n_df <- rbind(lasso_eta_gather_df,
                                       ...
                                       pysindy_eta_gather_df) %>%
  dplyr::filter(Condition == "Correct")
save(n_seq, total_correct_increasing_n_df, file = "success_rate_RData/duffing_inc_n_success_rate_new_sg.RData")
