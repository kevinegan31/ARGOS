...
## read files -----------------------------------------
x_dot_lasso_ci <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_xdot_lasso_ci_df.csv')[,-1]
x_dot_lasso_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_xdot_lasso_pe_df.csv')[,-1]
y_dot_lasso_ci <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_ydot_lasso_ci_df.csv')[,-1]
y_dot_lasso_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_ydot_lasso_pe_df.csv')[,-1]
z_dot_lasso_ci <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_zdot_lasso_ci_df.csv')[,-1]
z_dot_lasso_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_zdot_lasso_pe_df.csv')[,-1]

x_dot_alasso_ci <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_xdot_alasso_ci_df.csv')[,-1]
x_dot_alasso_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_xdot_alasso_pe_df.csv')[,-1]
y_dot_alasso_ci <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_ydot_alasso_ci_df.csv')[,-1]
y_dot_alasso_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_ydot_alasso_pe_df.csv')[,-1]
z_dot_alasso_ci <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_zdot_alasso_ci_df.csv')[,-1]
z_dot_alasso_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_zdot_alasso_pe_df.csv')[,-1]

x_dot_pysindy_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_xdot_pysindy_pe_df.csv')[,-1]
y_dot_pysindy_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_ydot_pysindy_pe_df.csv')[,-1]
z_dot_pysindy_pe <- read.csv('pred_model_csv/SNR/linear3d_inc_snr_zdot_pysindy_pe_df.csv')[,-1]
...
###
alasso_ridge_total_correct_eta <- rep(NA, nrow(xdot_alasso_eta_df))
alasso_ridge_total_correct_eta_df <- as.data.frame(matrix(NA, ncol = ncol(xdot_alasso_eta_df), nrow = 100))
for (i in seq_len(ncol(xdot_alasso_eta_df))) {
  new_df <- cbind(xdot_alasso_eta_df[, i],
                  ydot_alasso_eta_df[, i],
                  zdot_alasso_eta_df[, i])
  for (j in seq_len(nrow(new_df))) {
    alasso_ridge_identification <- rep(NA, nrow(xdot_alasso_eta_df))
    if (any(new_df[j, ] == 0)) {
...
write.csv(xdot_lasso_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_xdot_lasso_pred_models_new_sg.csv")
write.csv(ydot_lasso_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_ydot_lasso_pred_models_new_sg.csv")
write.csv(zdot_lasso_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_zdot_lasso_pred_models_new_sg.csv")

## alasso 
write.csv(xdot_alasso_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_xdot_alasso_pred_models_new_sg.csv")
write.csv(ydot_alasso_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_ydot_alasso_pred_models_new_sg.csv")
write.csv(zdot_alasso_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_zdot_alasso_pred_models_new_sg.csv")

## sindy 
write.csv(xdot_pysindy_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_xdot_sindy_pred_models_new_sg.csv")
write.csv(ydot_pysindy_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_ydot_sindy_pred_models_new_sg.csv")
write.csv(zdot_pysindy_prediction_model,
          "stacked_bar_csv/SNR/linear3d_inc_snr_zdot_sindy_pred_models_new_sg.csv")
...
save(eta, total_correct_increasing_snr_df, file = "success_rate_RData/linear3d_inc_snr_success_rate_new_sg.RData")
