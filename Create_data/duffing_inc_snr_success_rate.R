...
## read files -----------------------------------------
x_dot_lasso_ci <- read.csv('pred_model_csv/SNR/duffing_inc_snr_xdot_lasso_ci_df.csv')[,-1]
x_dot_lasso_pe <- read.csv('pred_model_csv/SNR/duffing_inc_snr_xdot_lasso_pe_df.csv')[,-1]
y_dot_lasso_ci <- read.csv('pred_model_csv/SNR/duffing_inc_snr_ydot_lasso_ci_df.csv')[,-1]
y_dot_lasso_pe <- read.csv('pred_model_csv/SNR/duffing_inc_snr_ydot_lasso_pe_df.csv')[,-1]

x_dot_alasso_ci <- read.csv('pred_model_csv/SNR/duffing_inc_snr_xdot_alasso_ci_df.csv')[,-1]
x_dot_alasso_pe <- read.csv('pred_model_csv/SNR/duffing_inc_snr_xdot_alasso_pe_df.csv')[,-1]
y_dot_alasso_ci <- read.csv('pred_model_csv/SNR/duffing_inc_snr_ydot_alasso_ci_df.csv')[,-1]
y_dot_alasso_pe <- read.csv('pred_model_csv/SNR/duffing_inc_snr_ydot_alasso_pe_df.csv')[,-1]

x_dot_pysindy_pe <- read.csv('pred_model_csv/SNR/duffing_inc_snr_xdot_pysindy_pe_df.csv')[,-1]
y_dot_pysindy_pe <- read.csv('pred_model_csv/SNR/duffing_inc_snr_ydot_pysindy_pe_df.csv')[,-1]
...
xdot_alasso_prediction_model <- out_csv2bar_csv_argos_n(x_dot_alasso_pe, x_dot_alasso_ci, eta_seq)
ydot_alasso_prediction_model <- out_csv2bar_csv_argos_n(y_dot_alasso_pe, y_dot_alasso_ci, eta_seq)
...
for (i in seq_len(nrow(xdot_lasso_prediction_model))) {
  if (
    ...
    rowSums(xdot_lasso_prediction_model[i,][, !names(xdot_lasso_prediction_model) %in% c("y")]
            != 0) == 0) {
...
for (i in seq_len(nrow(ydot_lasso_prediction_model))) {
  if (
    ...
    rowSums(ydot_lasso_prediction_model[i,][, !names(ydot_lasso_prediction_model) %in% c("x", "y", "xxx")]
            != 0) == 0) {
...
for (i in seq_len(nrow(xdot_alasso_prediction_model))) {
  if (
    ...
    rowSums(xdot_alasso_prediction_model[i,][, !names(xdot_alasso_prediction_model) %in% c("y")]
            != 0) == 0) {
...
for (i in seq_len(nrow(ydot_alasso_prediction_model))) {
  if (
    ...
    rowSums(ydot_alasso_prediction_model[i,][, !names(ydot_alasso_prediction_model) %in% c("x", "y", "xxx")]
            != 0) == 0) {
...
for (i in seq_len(nrow(xdot_pysindy_prediction_model))) {
  if (
    ...
    rowSums(xdot_pysindy_prediction_model[i,][, !names(xdot_pysindy_prediction_model) %in% c("y")]
            != 0) == 0) {
...
for (i in seq_len(nrow(ydot_pysindy_prediction_model))) {
  if (
    ...
    rowSums(ydot_pysindy_prediction_model[i,][, !names(ydot_pysindy_prediction_model) %in% c("x", "y", "xxx")]
            != 0) == 0) {
...
write.csv(xdot_lasso_prediction_model,
          "stacked_bar_csv/SNR/duffing_inc_snr_xdot_lasso_pred_models_new_sg.csv")
write.csv(ydot_lasso_prediction_model,
          "stacked_bar_csv/SNR/duffing_inc_snr_ydot_lasso_pred_models_new_sg.csv")

## alasso 
write.csv(xdot_alasso_prediction_model,
          "stacked_bar_csv/SNR/duffing_inc_snr_xdot_alasso_pred_models_new_sg.csv")
write.csv(ydot_alasso_prediction_model,
          "stacked_bar_csv/SNR/duffing_inc_snr_ydot_alasso_pred_models_new_sg.csv")

## sindy
write.csv(xdot_pysindy_prediction_model,
          "stacked_bar_csv/SNR/duffing_inc_snr_xdot_sindy_pred_models_new_sg.csv")
write.csv(ydot_pysindy_prediction_model,
          "stacked_bar_csv/SNR/duffing_inc_snr_ydot_sindy_pred_models_new_sg.csv")
...
save(eta, total_correct_increasing_snr_df, file = "success_rate_RData/duffing_inc_snr_success_rate_new_sg.RData")
